...
/*   Updated: 2018/09/26 21:41:58 by amaurel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					mantissa_length(uintmax_t mantissa, t_conversion conv);
int					nan_inf
...
int					int_length(intmax_t n, intmax_t base);
int					uint_length(uintmax_t n, intmax_t base);
